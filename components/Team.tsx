...
export function Team({ selectedLocation }: TeamProps) {
  ...
  const teamMembers = [
    {
      ...
      image: 'https://res.cloudinary.com/deasyoglq/image/upload/v1753687020/catherine_geecurly_master.jpg',
      specialties: ['Hair Styling', 'Business Leadership', 'Team Management'],
      experience: '8+ years',
      bio: 'Catherine is the visionary behind GeeCurly Salon. With over 8 years of experience, she leads our team with passion and expertise in delivering exceptional beauty services.',
      instagram: '@catherine_geecurly'
    },
    {
      id: 2,
      name: 'Njeri',
      ...
      experience: '5+ years',
      bio: 'Njeri is our braiding specialist who creates stunning protective styles. Her expertise in natural hair care makes her a client favorite at GeeCurly Salon.',
      instagram: '@njeri_geecurly'
    },
    {
      id: 3,
      name: 'Ann',
      ...
      experience: '4+ years',
      bio: 'Ann brings creativity to both hair and nail services at GeeCurly Salon. Her artistic touch and attention to detail ensure every client leaves feeling beautiful.',
      instagram: '@ann_geecurly'
    },
    {
      id: 4,
      name: 'Rachael',
      ...
      experience: '2+ years',
      bio: 'Rachael is our friendly face who ensures every client feels welcomed at GeeCurly Salon. She\'s also developing her styling skills under our senior team.',
      instagram: '@rachael_geecurly'
    }
  ]
  ...
  return (
    <section id="team" className="py-16 lg:py-24 bg-gradient-to-b from-teal-mint-light to-electric-pink-light">
      <div className="container-mobile">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center bg-white/80 backdrop-blur-sm border border-electric-pink/20 rounded-full px-6 py-2 mb-6">
            <User className="w-4 h-4 text-electric-pink mr-2" />
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <p className="text-sm text-electric-pink font-medium font-inter">{member.role}</p>
                  </div>
                  <div className="bg-gradient-to-r from-electric-pink-light to-teal-mint-light p-2 rounded-lg">
                    <Award className="w-4 h-4 text-electric-pink" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {member.specialties.map((specialty, idx) => (
                      <span 
                        key={idx}
                        className="text-xs bg-electric-pink-light text-electric-pink-dark px-2 py-1 rounded-full font-inter"
                      >
                        {specialty}
                      </span>
                    ))}
              ...
              {teamMembers.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all duration-300 ${
                    index === currentSlide ? 'bg-electric-pink w-8' : 'bg-gray-300'
                  }`}
                />
              ))}
            </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-gray-100 shadow-xl">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto font-inter">
              Book your appointment today and experience the GeeCurly Salon difference. 
            ...
            <button 
              onClick={() => {
                ...
                const message = `Hello GeeCurly Salon! I would like to book an appointment at your ${currentLocation.name} location.`
                window.open(`https://wa.me/254${currentLocation.phone}?text=${encodeURIComponent(message)}`, '_blank')
              }}
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-electric-pink to-deep-purple hover:from-electric-pink-dark hover:to-deep-purple-dark text-white px-8 py-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 font-inter"
            >
