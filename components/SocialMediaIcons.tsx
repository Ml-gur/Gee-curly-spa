// Social Media Icons - TikTok SVG and Instagram branded image
// TikTok icons created by Freepik - Flaticon
// Instagram icon from provided brand asset

// Import Instagram brand icon
import instagramBrandIcon from 'figma:asset/8c63d1d743da51cda0ee35407535b72b7b9215b9.png'
...
// Instagram Icon using provided brand image
export const InstagramIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <img 
    src={instagramBrandIcon} 
    alt="Instagram" 
    className={className}
  />
)
...
// Compact Instagram icon for small spaces using brand image
