...
export function SpecialOffers({ selectedLocation }: SpecialOffersProps) {
  ...
  const handleBookOffer = (offerTitle: string) => {
    ...
    const message = `Hello GeeCurly Salon! I'm interested in the "${offerTitle}" offer at your ${currentLocation.name} location.`
    window.open(`https://wa.me/254${currentLocation.phone}?text=${encodeURIComponent(message)}`, '_blank')
  }

  return (
    <section id="offers" className="py-16 lg:py-24 bg-gradient-to-b from-electric-pink-light via-teal-mint-light to-deep-purple-light">
      <div className="container-mobile">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center bg-white/80 backdrop-blur-sm border border-electric-pink/20 rounded-full px-6 py-2 mb-6">
            <Gift className="w-4 h-4 text-electric-pink mr-2" />
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto font-inter">
            ...
            the GeeCurly treatment you deserve at unbeatable prices.
          </p>
        </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            ...
            {/* Countdown Timer */}
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-electric-pink to-deep-purple text-white rounded-2xl px-6 py-3 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {/* Offer 1 */}
            <div className="group relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-2 border-electric-pink/20">
              <div className="absolute top-4 right-4 bg-electric-pink text-white px-3 py-1 rounded-full text-sm font-bold animate-pulse">
                50% OFF
              </div>
              ...
              <div className="p-6">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <span className="text-sm font-semibold text-electric-pink font-inter">LIMITED TIME</span>
                </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <span className="text-2xl font-bold text-electric-pink font-inter">KES 2,500</span>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-electric-pink to-deep-purple hover:from-electric-pink-dark hover:to-deep-purple-dark text-white py-3 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center justify-center space-x-2 font-inter"
                >
        ...
        <div className="text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-gray-100 shadow-xl max-w-4xl mx-auto">
            ...
            <button 
              onClick={() => {
                const currentLocation = locations[selectedLocation]
                const message = `Hello GeeCurly Salon! I would like to book an appointment and learn about your special offers at your ${currentLocation.name} location.`
                window.open(`https://wa.me/254${currentLocation.phone}?text=${encodeURIComponent(message)}`, '_blank')
              }}
